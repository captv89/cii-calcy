<div class="home">
	<h1>What is the CII?</h1>

	<p>
		The CII (Carbon Intensity Indicator) is a measure for a ship’s energy efficiency and is given in
		grams of CO2 emitted per cargo-carrying capacity and nautical mile. Vessels receive an
		environmental rating of A (major superior), B (minor superior), C (moderate), D (minor
	...
	<p>
		...
		from the original article. For the complete information, refer to the original source on the <a
			href="https://www.dnv.com/maritime/insights/topics/CII-carbon-intensity-indicator/index.html"
			>DNV website</a
		>.
	</p>
	<br /> 
